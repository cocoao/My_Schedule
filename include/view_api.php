<div class="categoryTabs">
    ...
    <a href="/my_schedule/pages/sch_view.php?key=view_api" class="active">API</a>
  ...
  <ul class="boardTable">
    ...
    $sql="select * from schedule_txt where sch_txt_cate='API project' order by sch_txt_num desc";
