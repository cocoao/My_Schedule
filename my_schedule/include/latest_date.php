<?php
  ...
  $db_date_sql="select * from schedule_txt where sch_txt_cate='DB project' order by sch_txt_num desc limit 1";
  ...
  $api_date_sql="select * from schedule_txt where sch_txt_cate='API project' order by sch_txt_num desc limit 1";
  ...
  $ren_date_sql="select * from schedule_txt where sch_txt_cate='RENEWAL project' order by sch_txt_num desc limit 1";
  ...
  $port_date_sql="select * from schedule_txt where sch_txt_cate='PORTFOLIO project' order by sch_txt_num desc limit 1";
